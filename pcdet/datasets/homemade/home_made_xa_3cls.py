...
class Homemade_Dataset_XA_3cls(DatasetTemplate):
    def __init__(self, dataset_cfg, class_names, training=True, root_path=None, logger=None):
        ...
        self.cls_dict = {'little_car':1,'Cone':2,'Pedestrian':3}
    ...
    def evaluation(self, det_annos, class_names, **kwargs):
        ...
        from .kitti_object_eval_python import eval_homemade_1 as eval_homemade_1
...
def create_kitti_infos(dataset_cfg, class_names, data_path, save_path, workers=4):
    dataset = Homemade_Dataset_XA_3cls(dataset_cfg=dataset_cfg, class_names=class_names, root_path=data_path, training=False)
...
if __name__ == '__main__':
    ...
    dataset_cfg = EasyDict(yaml.safe_load(open('/home/xionggaoyang/xgy/OpenPCDet-master/tools/cfgs/dataset_configs/ssl_homemade_dataset.yaml')))
    ROOT_DIR = '/home/xionggaoyang/xgy/OpenPCDet-master/data/ssl_dataset_full'
