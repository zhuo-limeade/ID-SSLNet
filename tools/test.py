...
def parse_config():
    ...
    parser.add_argument('--ckpt_dir', type=str, default='/home/ken/workspace/OpenPCDet/output/second_mod1_car/second_mod1_car/default/ckpt', help='specify a ckpt directory to be evaluated if needed')
